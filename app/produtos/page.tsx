...
export default function ProdutosPage() {
  ...
  return (
    <>
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-20 pt-28 sm:px-6 sm:pb-24 sm:pt-32 lg:px-12">
        {/* Hero */}
        <motion.div
        ...
        {/* CTA */}
        <motion.div
          className="mt-20 rounded-2xl border border-primary/20 bg-primary/5 p-6 text-center sm:p-10"
