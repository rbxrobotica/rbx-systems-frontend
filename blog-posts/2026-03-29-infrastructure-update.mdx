...
If you are a developer, DevOps engineer, or just someone who is curious about how a small team runs production Kubernetes with ArgoCD, GitOps, and external databases — the repository is there to read, fork, and learn from.

We specifically want to hear from people interested in:

- **Robotics and automation** — our core domain
- **Algorithmic trading** — Robson is built for real-world strategy execution
...
If you find a bug, open an issue. If you have an idea, open a discussion. If you want to contribute, the door is open.
